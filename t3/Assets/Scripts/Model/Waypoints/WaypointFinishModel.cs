...
{
    public class WaypointFinishModel : IWaypointModel
    {
        private static WaypointFinishModel _instance;
        //private List<Transform> _waypoints = new List<Transform>();
        private HashSet<Transform> _availableChairs = new HashSet<Transform>();


        private WaypointFinishModel() 
        {
            
        }
        public static WaypointFinishModel GetInstance()
        {
            if ( _instance == null )
            {
                _instance = new WaypointFinishModel();
            }
            return _instance;
        }
